...
<body>
    ...
    <div id="container">
	 ...
	 <div id="menu">
        	<a href="../penilai/index.php">Home</a>
            <a href="../penilai/download.php"class="active">Data Appraisal</a>
			<a href="../penilai/user.php">User</a>
        </div>
         <div id="content">
        	<h2>Edit</h2>
            </div>
...
<table border="0" cellpadding="5" cellspacing="0">
 <table width="100%" align="center" border="0" bgcolor="#eee" cellpadding="2" cellspacing="0">
        ...
        <tr>
          ...
          <td><b>:</b></td>
          <td>
		  <select name="status_penilaian" class="form-control" required>
          <option value="">Pilih Status</option>
		  <option value="Baru">Baru</option>
		  <option value="Perpanjangan">Perpanjangan</option>
		  <option value="Penambahan + Perpanjangan">Penambahan + Perpanjangan</option>
		  <option value="Penambahan (Objek Baru)">Penambahan (Objek Baru)</option>
		  <option value="Penambahan Plafon">Penambahan Plafon</option>
		  </select>
		  </td>
        </tr>
        <tr>

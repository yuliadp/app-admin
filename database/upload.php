...
<div id="container">
  <div id="header">
    ...
    <span>Dibuat oleh YuliaDp</span> </div>
  <div id="menu"> <a href="../database/index.php">Home</a> <a href="../database/upload.php"class="active">Upload</a> <a href="../database/download.php">Download</a> <a href="../database/user.php">User</a> </div>
  <div id="content">
    <h2>Upload</h2>
    ...
    <form method="post" enctype="multipart/form-data" action="">
      <table width="100%" align="center" border="0" bgcolor="#eee" cellpadding="2" cellspacing="0">
        ...
        <tr>
          ...
          <td><b>:</b></td>
          <td><input type="text" name="divisi" size="60" required /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><b>:</b></td>
          <td><input type="date" name="tanggal_survey" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Tanggal Laporan</b></td>
          <td><b>:</b></td>
          <td><input type="date" name="tanggal_laporan" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Status Penilaian</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="status_penilaian" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Jenis Jaminan</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="jenis_jaminan" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Pasar</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="mv" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Likuidasi</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="lv" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Keterangan</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="keterangan" size="60" height="100" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nama Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="nama_tl" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Pasar Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="mv_tl" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Likuidasi Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="lv_tl" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Keterangan Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="keterangan_tl" size="60" height="100" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Tanggal Review Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="date" name="tanggal_review_tl" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nama Unit Head</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="nama_uh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Pasar Unit Head</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="mv_uh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Likuidasi Unit Head</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="lv_uh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Keterangan Unit Head</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="keterangan_uh" size="60" height="100
					" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Tanggal Review Unit Head</b></td>
          <td><b>:</b></td>
          <td><input type="date" name="tanggal_review_uh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nama Dept Head</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="nama_dh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Pasar Dept Head</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="mv_dh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Likuidasi Dept Head</b></td>
          <td><b>:</b></td>
          <td><input type="decimal" name="lv_dh" size="60" required /></td>
        </tr>
        <tr>
          <td align="right"><b>Keterangan Dept Head</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="keterangan_dh" size="60" height="100
					" required /></td>
        </tr>
        <tr>

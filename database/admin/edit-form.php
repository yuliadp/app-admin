...
<table border="0" cellpadding="5" cellspacing="0">
 <table width="100%" align="center" border="0" bgcolor="#eee" cellpadding="2" cellspacing="0">
        ...
        <tr>
          ...
          <td><b>:</b></td>
          <td><input type="text" name="nama_tl" size="60" value="<?php echo $data['nama_tl']; ?>" hidden /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Pasar Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="mv_tl" size="60" value="<?php echo $data['mv_tl']; ?>" hidden /></td>
        </tr>
        <tr>
          <td align="right"><b>Nilai Likuidasi Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="lv_tl" size="60" value="<?php echo $data['lv_tl']; ?>" hidden /></td>
        </tr>
        <tr>
          <td align="right"><b>Keterangan Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="text" name="keterangan_tl" size="60" height="100" value="<?php echo $data['keterangan_tl']; ?>" hidden /></td>
        </tr>
        <tr>
          <td align="right"><b>Tanggal Review Team Leader</b></td>
          <td><b>:</b></td>
          <td><input type="date" name="tanggal_review_tl" size="60" value="<?php echo $data['tanggal_review_tl']; ?>" hidden /></td>
        </tr>
        <tr>

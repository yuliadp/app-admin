...
<body>
    ...
    <div id="container">
	 ...
	 <div id="menu">
            ...
            <a href="../dept_head/download.php"class="active">Data Appraisal</a>
			<a href="../dept_head/user.php">User</a>
        </div>
         <div id="content">
        	<h2>Edit</h2>
            </div>
...
<form name="update_data" action="../dept_head/update-form.php" method="post" enctype="multipart/form-data">

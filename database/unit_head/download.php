...
<body>
    ...
    <div id="container">
	 ...
	 <div id="menu">
        	<a href="../unit_head/index.php">Home</a>
            <a href="../unit_head/download.php"class="active">Data Appraisal</a>
			<a href="../unit_head/user.php">User</a>
        </div>
   ...
   if (mysql_num_rows($result) == 0) {
	...
	<table class="table" width="100%" cellpadding="3" cellspacing="0">
    	<tr>
			...
			<td><a href="../unit_head/edit-form.php?id=<?php echo $data['id_laporan']; ?>">Edit</a>
          </tr>
	  <?php
          $no++;

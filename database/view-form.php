...
<head>
	<title>Laporan Appraisal</title>
     <link rel="stylesheet" type="text/css" href="../database/style2.css">
</head>
<body>
	...
	<div id="menu">
            ...
            <a href="../database/download.php" class="active">Download</a>
...
?>
<a href="../database/upload.php">+ Tambah Data</a>
<table class="table" width="100%" cellpadding="3" cellspacing="0">
    	<tr>
            ...
            <td><a href="file_upload/<?php echo $data['file']; ?>.pdf" class="btn btn-primary btn-sm">Download</a></td>
			<td><a href="../database/edit-form.php?id=<?php echo $data['id_laporan']; ?>">Edit</a> || 
                <a href="../database/delete-form.php?id=<?php echo $data['id_laporan']; ?>">Delete</a></td>
          </tr>
	  <?php
          $no++;
